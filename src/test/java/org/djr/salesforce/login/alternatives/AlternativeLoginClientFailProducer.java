...
import org.djr.salesforce.login.mockclients.MockSalesforceClientFailure;
...
@ApplicationScoped
public class AlternativeLoginClientFailProducer {
    ...
    public LoginClient loginClientProducer() {
        ...
        LoginClient mockLoginClient = new MockSalesforceClientFailure(behaviorDelegate);
